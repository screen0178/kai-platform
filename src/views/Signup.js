                    ...
                    <div className="mt-10">
                        <form className="flex flex-col" onSubmit={handleSubmit(onSubmit)}>
                            <div className="mb-6 pt-3 rounded bg-gray-200 ">
                                ...
                                <input name="email" type="text" id="email" ref={register({ required: "Email is Required",pattern: { value: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i, message: "Invalid email address"}})} className="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 hover:border-yellow-600 focus:border-red-600 transition duration-500 px-3 pb-3" />
                                {errors.email && 
                            ...
                            {loading ? 
                                <input className="animate-pulse bg-yellow-700 text-white font-bold py-2 rounded shadow-xl " type="submit" value="Processing..." disabled/>
                            :

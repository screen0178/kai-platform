...
const AnomalyChartKm0Va = () => {
    ...
    useEffect(() => {
        ...
        getData().then(res => {
            ...
            for (let i = 0; i < chartData.map(el => { return el.va}).length; i++){
                    ...
                    datasets: [
                        {
                            ...
                            data: chartData.map(el => { return el.va}),
                            fill: false
                        }
                    ]
                },
            ...
            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 mt-10 shadow-lg rounded bg-white">
              ...
              <div className="p-4 flex-auto">
                ...
                <div className="relative" style={{ height: "350px" }}>
                  <canvas id="Testchart" ref={chartRef}></canvas>
                </div>
              </div>
            </div>
          </div>
...
export default AnomalyChartKm0Va